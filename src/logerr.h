...
{
    if (logEntryType==LogEntryType::warn && !logOptions.allowWarn(warnType))
        return logNul;
...
#define LOG_ERR                 startLogError( logErr, LogEntryType::err ,  /* gopts, */  "err", curFile.c_str(), lineNo, __FILE__, __LINE__ )
#define LOG_WARN(warnType)      startLogError( logErr, LogEntryType::warn,  /* gopts, */  warnType , curFile.c_str(), lineNo, __FILE__, __LINE__ )
                                                                            /*        */ 
// options and other errors                                                 /*        */ 
#define LOG_ERR_OPT             startLogError( logErr, LogEntryType::err ,  /* gopts, */  "err", 0, 0, __FILE__, __LINE__ )
#define LOG_WARN_OPT(warnType)  startLogError( logErr, LogEntryType::warn,  /* gopts, */  warnType , 0, 0, __FILE__, __LINE__ )
                                                                            /*        */ 
#define LOG_MSG_OPT             startLogError( logMsg, LogEntryType::msg ,  /* gopts, */  "msg", 0, 0, 0, 0 )
